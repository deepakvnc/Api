...
function Statistics(canvas, breadcrumbs){
   // $(function(canvas, breadcrumbs)  {
    ...
    this.getData = function(keep_period){
        ...
        console.log("Dealer - ",currentContainer.find('#group'));
...
</script><?php /**PATH C:\xampp\htdocs\VNC\test\Mbdiag_demo\Mbdiag_demo_v4_bal\resources\views/Diagnosis/Tabs/reports.blade.php ENDPATH**/ ?>