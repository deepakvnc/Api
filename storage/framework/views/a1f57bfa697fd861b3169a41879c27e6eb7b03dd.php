        ...
        <div class="box-content">
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col field-row number-spinner-active">
                    ...
                    <div readonly="readonly" id="mileage_end_div"class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input readonly="readonly" class="mdl-textfield__input saveonchange add_media complete_input" pattern="-?[0-9]*(\.[0-9]+)?" type="number" name="mileage_end" value="10000" id="mileage_end" onBlur="setFieldname(this.name)" />
...
<?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/Diagnosis/ViewTabs/Complete.blade.php ENDPATH**/ ?>