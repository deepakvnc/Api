            ...
            <table id="diagnosis_overview" class="datatable stripe" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td onclick="window.location='<?php echo e(url('/diagnosis/edit', $item->id)); ?>'"><?php echo e($item->complaint_number); ?></td>
                        ...
                        <td onclick="window.location='<?php echo e(url('/diagnosis/edit', $item->id)); ?>'" class="hidemobile"><?php echo date('d-m-Y', strtotime($item->creationdate))?></td>
...
<?php /**PATH C:\xampp\htdocs\VNC\test\Mbdiag_demo\Mbdiag_demo_v4_bal\resources\views/Diagnosis/Tabs/diagnosis.blade.php ENDPATH**/ ?>