            ...
            <div class="mdl-grid">
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--3-col mdl-cell--4-col-phone mdl-textfield--align-right mdl-zebra__desktop mdl-zebra__phone">
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="intake_protocol_5f19d87769cd8">
                        <input readonly="readonly" value="1" class="mdl-radio__button saveonchange" large="1" name="intake_protocol" type="radio" id="intake_protocol_5f19d87769cd8">
                        <span class="mdl-radio__label">Yes</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="intake_protocol_5f19d87769d23">
                        <input readonly="readonly" value="2" class="mdl-radio__button saveonchange" large="1" name="intake_protocol" type="radio" id="intake_protocol_5f19d87769d23">
                        <span class="mdl-radio__label">No</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="intake_protocol_5f19d87769d6a">
                        <input readonly="readonly" value="3" class="mdl-radio__button saveonchange" large="1" name="intake_protocol" type="radio" id="intake_protocol_5f19d87769d6a">
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--3-col mdl-cell--4-col-phone mdl-textfield--align-right mdl-zebra__desktop mdl-zebra__phone">
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="voltage_sustain_5f19d87769db3">
                        <input readonly="readonly" value="1" class="mdl-radio__button saveonchange" large="1" name="voltage_sustain" type="radio" id="voltage_sustain_5f19d87769db3">
                        <span class="mdl-radio__label">Yes</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="voltage_sustain_5f19d87769df7">
                        <input readonly="readonly" value="2" class="mdl-radio__button saveonchange" large="1" name="voltage_sustain" type="radio" id="voltage_sustain_5f19d87769df7">
                        <span class="mdl-radio__label">No</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="voltage_sustain_5f19d87769e3b">
                        <input readonly="readonly" value="3" class="mdl-radio__button saveonchange" large="1" name="voltage_sustain" type="radio" id="voltage_sustain_5f19d87769e3b">
                        <span class="mdl-radio__label">NA</span>
                    </label>
                </div>
                <div class="mdl-cell mdl-cell--9-col mdl-cell--5-col-tablet mdl-cell--2-col-phone field-row">
                ...
                <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-phone mdl-textfield--align-right mdl-zebra__desktop mdl-zebra__phone">
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="error_present_5f19d87769f7d">
                        <input readonly="readonly" class="mdl-radio__button saveonchange hascomment" large="1" name="error_present" type="radio" id="error_present_5f19d87769f7d">
                        <span class="mdl-radio__label">Yes</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="error_present_5f19d87769fc5">
                        <input readonly="readonly" class="mdl-radio__button saveonchange hascomment" large="1" name="error_present" type="radio" id="error_present_5f19d87769fc5">
                        <span class="mdl-radio__label">No</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="error_present_5f19d8776a009">
                        <input readonly="readonly" class="mdl-radio__button saveonchange hascomment" large="1" name="error_present" type="radio" id="error_present_5f19d8776a009">
                        <span class="mdl-radio__label">NA</span>
                    </label>
                </div>
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--2-col mdl-textfield--align-right mdl-zebra__desktop mdl-zebra__phone">
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="tip_5f19d8776a068">
                        <input readonly="readonly" value="1" class="mdl-radio__button saveonchange hascomment tip" large="1" name="tip" type="radio" id="tip_5f19d8776a068">
                        <span class="mdl-radio__label">Yes</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="tip_5f19d8776a0ac">
                        <input readonly="readonly" value="0" class="mdl-radio__button saveonchange hascomment tip" large="1" name="tip" type="radio" id="tip_5f19d8776a0ac">
                        <span class="mdl-radio__label">No</span>
                    </label>
                </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-cell--4-col-phone field-row tip_comment comment-field-closed">
                    ...
                    <div readonly="readonly"class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input readonly="readonly" class="mdl-textfield__input saveonchange add_media" type="text" name="tip_description" value="" id="tip_description" onBlur="setFieldname(this.name)" />
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-cell--4-col-phone field-row tip_comment comment-field-closed">
                    <i id="icon-tip_version" class="material-icons"></i>
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input readonly="readonly" class="mdl-textfield__input saveonchange add_media" type="text" name="tip_version" value="" id="tip_version" onBlur="setFieldname(this.name)" />
...
</div><?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/Diagnosis/ViewTabs/Activities.blade.php ENDPATH**/ ?>