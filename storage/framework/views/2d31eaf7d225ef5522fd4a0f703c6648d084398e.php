            ...
            <div class="mdl-grid center-items">
                ...
                <div
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input onchange="saveOnChange(value,'wo_number')" class="mdl-textfield__input saveonchange add_media id_input" type="text" name="wo_number"
                            value="<?php if ($diagnosis) {
                                echo $diagnosis[0]->wo_number;
                            } else {
                                echo '';
                            } ?>" id="wo_input" onBlur="setFieldname(this.name)" />
                        <input type="hidden" id="diagnosis_id" name="diagnosis_id" value="<?php if ($diagnosis) {
                            echo $diagnosis[0]->id;
                        } else {
                            echo '';
                        } ?>">
                ...
                <div
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input onchange="saveOnChange(value, 'complaint_number')" class="mdl-textfield__input saveonchange add_media id_input" min="1" max="99"
                ...
                <div class="mdl-cell mdl-cell--2-col mdl-cell--8-col-tablet mdl-cell--4-col-phone field-row"
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input onchange="saveOnChange(value, 'license_plate')" class="mdl-textfield__input saveonchange add_media" type="text" name="license_plate"
                            value="<?php if ($diagnosis) {
                    ...
                    <div class="mdl-grid mdl-grid--no-spacing">
                        <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet mdl-cell--4-col-phone field-row">
                            ...
                            <div
                                ...
                                <input onchange="saveOnChange(value, 'vin')" class="mdl-textfield__input saveonchange add_media uppercase id_input"
                ...
                <div
                    ...
                    <div class="mdl-grid mdl-grid--no-spacing center-items">
                        ...
                        <div class="mdl-cell mdl-cell--4-col mdl-textfield--align-right" id="repeat_repair">
                            <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect"
                                for="repeat_repair_5f19d87768bb5">
                                <input onchange="saveOnChange(value, 'repeat_repair')" value="1" class="mdl-radio__button saveonchange id_radio" large="1"
                            ...
                            <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect"
                                ...
                                <input onchange="saveOnChange(value, 'repeat_repair')" value="0" class="mdl-radio__button saveonchange id_radio" large="1"
                        ...
                        <div class="mdl-cell mdl-cell--4-col mdl-textfield--align-right" id="complaint_reproducible">
                            <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect"
                                for="complaint_callable_5f19d87768c62">
                                <input onchange="saveOnChange(value, 'complaint_callable')" value="1" class="mdl-radio__button saveonchange" large="1"
                                ...
                                <input onchange="saveOnChange(value, 'complaint_callable')" value="0" class="mdl-radio__button saveonchange" large="1"
                        ...
                        <div
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group"
                                id="mileage-test">
                                <input onchange="saveOnChange(value,'mileage_start')" class="mdl-textfield__input saveonchange add_media id_input"
...
<?php /**PATH C:\xampp\htdocs\mbdiag\CodeForIntegration\Deepak\Mdiag_Demo\7thsept\resources\views/Diagnosis/EditTabs/Id.blade.php ENDPATH**/ ?>