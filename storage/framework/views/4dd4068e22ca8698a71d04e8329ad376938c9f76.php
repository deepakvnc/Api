...
<main class="mdl-layout__content allow-scroll">
    <div class="page-content">
        <div class="mdl-viewpager">
            <?php echo $__env->make('Diagnosis.ViewTabs.Id', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('Diagnosis.ViewTabs.Findings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('Diagnosis.ViewTabs.Activities', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('Diagnosis.ViewTabs.Analysis', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('Diagnosis.ViewTabs.Follow_up', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('Diagnosis.ViewTabs.Media', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('Diagnosis.ViewTabs.Extra', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('Diagnosis.ViewTabs.Complete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    ...
    <div id="modal-cpydiagnosis" class="modal-window">
        <div>
            ...
            <div class="modal-footer">
                ...
                <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored"  onclick="copy('6','false','false')">Copy</a>
            </div>
        </div>
    </div>
    ...
    <div id="modal-uir-voltage" class="modal-window">
        <div>
            <div class="current_field">
                ...
                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored fullwidth" onclick="" style="margin-top:20px;">
                    <i class="material-icons">photo_camera</i>
                    <label>Add media</label>
                </button>
            </div>
    ...
    <div id="modal-uir-current" class="modal-window">
        <div>
            <div class="power_field">
                ...
                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored fullwidth" onclick="">
                    <i class="material-icons">photo_camera</i>
                    <label>Add media</label>
                </button>
            </div>
    ...
    <div id="modal-uir-battery" class="modal-window">
        <div>
            <div class="battery_field">
                ...
                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored fullwidth" onclick="">
                    <i class="material-icons">photo_camera</i>
                    <label>Take a picture of the test strip</label>
                </button>
            </div>
    ...
    <div id="modal-visualcheck" class="modal-window">
        <div class="modal-content">
            ...
            <div class="">
                ...
                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored fullwidth" onclick="$('#add-media-to-field').click()" style="margin-top:20px;">
                    <i class="material-icons">photo_camera</i>
                    <label>Add media</label>
                </button>
            </div>
    ...
    <div id="modal-shorttest" class="modal-window">
        <div class="modal-content">
            <div class="">
                ...
                <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored fullwidth" onclick="">
                    <i class="material-icons">photo_camera</i>
                    <label>Add media (required)</label>
                </button>
            </div>
            <div class="modal-footer">
        ...
        <div class="modal-content">
            <div class="">
                <div class="mdl-grid mdl-grid--no-spacing">
                    ...
                    <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored fullwidth" onclick="$('#add-media-to-field').click()" data-upgraded=",MaterialButton">
                        <i class="material-icons">photo_camera</i>
                        <label>Add media</label>
                    </button>
                </div>
    ...
    function copy(diagnosis_id,test_drive,short_test)
    {
...
<?php echo $__env->make('layouts.index_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/Diagnosis/view.blade.php ENDPATH**/ ?>