                ...
                <tbody>
                    <?php $__currentLoopData = $quality_control; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td onclick="window.location='<?php echo e(url('/quality_control/edit', $item->id)); ?>'">
                                <?php echo e($item->inspector_first_name); ?> <?php echo e($item->inspector_surname_prefix); ?>

                                <?php echo e($item->inspector_surname); ?></td>
                            <td onclick="window.location='<?php echo e(url('/quality_control/edit', $item->id)); ?>'">
                                <?php echo e($item->employee_first_name); ?> <?php echo e($item->employee_surname_prefix); ?>

                                <?php echo e($item->employee_surname); ?></td>
                            <td onclick="window.location='<?php echo e(url('/quality_control/edit', $item->id)); ?>'"
            ...
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                    <a style="padding:0;"
                        ...
                        href="question/overview">Maintenance / Repair</a> </div>
                <div class="mdl-cell mdl-cell--12-col">
                    <a style="padding:0;"
                        class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored spf-link fullwidth"
                        href="question/overview">Warranty / Diagnosis</a> </div>
                <div class="mdl-cell mdl-cell--12-col">
                    <a style="padding:0;"
                        class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored spf-link fullwidth"
...
<?php /**PATH C:\xampp\htdocs\VNC\test\Mbdiag_demo\Mbdiag_demo_v4_bal\resources\views/inc/QualityControl/quality_control.blade.php ENDPATH**/ ?>