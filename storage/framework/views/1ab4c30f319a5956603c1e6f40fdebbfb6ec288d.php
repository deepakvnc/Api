                            ...
                            <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-cell--4-col-phone field-row mdl-zebra__desktop mdl-zebra__phone">
                             <i id="icon-mechanic_id" class="material-icons"></i>
                                ...
                                if($quality_control)
                                                ...
                                                ?>
                                    <div class="mdl-selectfield mdl-js-selectfield is-dirty" tabindex="-1">
                                    <select class="fullwidth mdl-selectfield__select saveonchange id_input" id="employee" name="employee" value="<?php echo $employee?>" onchange="saveOnChange(value,'employee')">
                                    <?php
                                      if($quality_control)
                                        $disabled = "disabled";
                                     else
                                  ...
                                  </select><label class="mdl-textfield__label" for="employee" id="employee" style=>Mechanic</label>
                                <label class="mdl-textfield__label" for="employee" id="employee" style=>Mechanic</label></div>
                                </div>
                            </div>
                            <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-cell--4-col-phone field-row mdl-zebra__desktop mdl-zebra__phone">
...
$('#employee').change(function() {
                        ...
                        if (check_value == null) {
                            $("#icon-mechanic-id").html("fiber_manual_record");
                            $("#icon-mechanic_id").addClass("error");
                            $("#icon-mechanic_id").removeClass("success");
                        } else {
                            $("#icon-mechanic_id").html("check");
                ...
                <div class="box box-border">
                    ...
                    <div class="box-content">
                        <div class="mdl-grid center-items">
                            ...
                            <input value="1" class="mdl-radio__button "   large="1" name="33" type="radio" id="33_5f1ad85a13204" onClick="technical_yes(value)">
                            ...
                            <input value="1" class="mdl-radio__button saveonchange" large="1" name="49" type="radio" id="49_5f1ad85a13980" onClick="accssories_radio(value)"><span class="mdl-radio__label">Yes</span></label><label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="49_5f1ad85a139c5">
                    ...
                    <div class="box-content">
                        <div class="mdl-grid">
                            <div class="mdl-cell mdl-cell--12-col">
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label saveonchange  fullwidth  form-group"><textarea class="mdl-textfield__input " type="text" name="comments" value="" id="comments" onchange="saveOnChange(value,'comments')">
                                <?php
                                if($quality_control)
                                echo $quality_control[0]->comments?>
                                </textarea><label class="mdl-textfield__label" for="comments">Comments</label></div>
                            </div>
...
<?php echo $__env->make('layouts.index_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mbdiag\CodeForIntegration\Sasikala\15thSept\resources\views/QualityControl/EditPanels.blade.php ENDPATH**/ ?>