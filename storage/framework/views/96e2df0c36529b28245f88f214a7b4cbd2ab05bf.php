<div class="mdl-layout__tab-panel" id="complete_panel">
    <div class="box box-border">
        ...
        <div class="box-content">
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col field-row number-spinner-active"><i class="material-icons" data-for="mileage_end">check</i>
    ...
    </script><?php /**PATH C:\xampp\htdocs\VNC\test\Mbdiag_demo\Mbdiag_demo_v4_bal\resources\views/Diagnosis/EditTabs/Complete.blade.php ENDPATH**/ ?>