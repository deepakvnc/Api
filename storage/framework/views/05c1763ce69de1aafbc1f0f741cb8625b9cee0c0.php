<div class="mdl-layout__tab-panel" id="media_panel">
    ...
    <div readonly="readonly" class="preview-images-zone pictureswipe_wrap tab_media" itemscope itemtype="http://schema.org/ImageGallery"> </div>
        </div>
    <input readonly="readonly" type="file" id="pro-image" name="pro-image" style="display: none;" class="form-control" multiple>
...
<?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/Diagnosis/ViewTabs/Media.blade.php ENDPATH**/ ?>