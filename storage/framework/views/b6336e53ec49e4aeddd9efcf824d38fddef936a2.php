                ...
                <div class="mdl-grid center-items" style="user-select: none; -webkit-user-select: none;">
                    <div class="mdl-cell mdl-cell--2-col mdl-cell--4-col-tablet mdl-cell--4-col-phone field-row mdl-zebra__desktop mdl-zebra__phone">
                        <div class="mdl-selectcontainer">
                            ...
                            <select id="year" name="year" value=""  onchange="yearData(this.value)" class="fullwidth mdl-selectfield__select">
                    ...
                    <div class="mdl-cell mdl-cell--2-col mdl-cell--4-col-tablet mdl-cell--4-col-phone field-row mdl-zebra__desktop mdl-zebra__phone">
                        <div class="mdl-selectcontainer">
                            <div class="mdl-selectfield mdl-js-selectfield is-dirty" tabindex="-1">
                              <select class="fullwidth mdl-selectfield__select filter" id="group" name="group" value="" onchange="datachange(this.value)">
                    ...
                    <div class="mdl-cell mdl-cell--2-col mdl-cell--4-col-tablet mdl-cell--4-col-phone field-row mdl-zebra__desktop mdl-zebra__phone">
                        <div class="mdl-selectcontainer">
                            <div class="mdl-selectfield mdl-js-selectfield is-dirty" tabindex="-1">
                          <select id="user" name="user" value="" onchange="dataChanges(this.value)" class="fullwidth mdl-selectfield__select">
                                    <option value="" selected>&nbsp;</option>
                    ...
                    <canvas id="mbchart" style="height: 210px; width: 1485px;"></canvas>
...
options: {
            ...
            title: {
              display: true,
              text: "# of Quality Controls in "+year
            },
...
<iframe id="history-iframe" src="javascript:&quot;&quot;" style="display: none;" src="./MB-Diag_files/saved_resource.html"></iframe></body></html><?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/inc/QualityControl/statistics.blade.php ENDPATH**/ ?>