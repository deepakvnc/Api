    ...
    <div class="box box-border">
        ...
        <div class="box-content">
            <div class="mdl-grid">
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--11-col mdl-cell--5-col-tablet mdl-cell--4-col-phone field-row mdl-zebra__desktop mdl-zebra__phone">
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        ...
                        <label readonly="readonly" class="mdl-textfield__label" for="wis_document">Wis Document</label>
                    <div class="pictureswipe_wrap tab_media" itemscope itemtype="http://schema.org/ImageGallery">
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--3-col mdl-cell--4-col-phone mdl-textfield--align-right">
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="exit_protocol_5f19d8776a95f">
                        <input readonly="readonly" value="1" class="mdl-radio__button saveonchange" large="1" name="exit_protocol" type="radio" id="exit_protocol_5f19d8776a95f">
                        <span class="mdl-radio__label">Yes</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="exit_protocol_5f19d8776a9a7">
                        <input readonly="readonly"value="2" class="mdl-radio__button saveonchange" large="1" name="exit_protocol" type="radio" id="exit_protocol_5f19d8776a9a7">
                        <span class="mdl-radio__label">No</span>
                    </label>
                    <label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="exit_protocol_5f19d8776a9eb">
                        <input readonly="readonly" value="3" class="mdl-radio__button saveonchange" large="1" name="exit_protocol" type="radio" id="exit_protocol_5f19d8776a9eb">
            ...
            <div class="mdl-grid error_code_list" id="testlist">
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--2-col">
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input readonly="readonly" data-id="0" required="required" class="mdl-textfield__input add_media error_codes" pattern="[0,1]{1,1}" maxlength="1" data-maxlength="1" type="number" name="error_code_1" value="" id="error_code_1" onBlur="setFieldname(this.name)"/>
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--2-col">
                    <div readonly="readonly" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input readonly="readonly" data-id="0" required="required" class="mdl-textfield__input add_media error_codes" pattern="[A-Z,a-z,0-9]{5,5}" maxlength="5" data-maxlength="5" type="text" name="error_code_2" value="" id="error_code_2" onBlur="setFieldname(this.name)"/>
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--2-col">
                    <div readonly="readonly" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input readonly="readonly" data-id="0" required="required" class="mdl-textfield__input add_media error_codes" pattern="[A-Z,a-z,0-9,*]{2,2}" maxlength="2" data-maxlength="2" type="text" name="error_code_3" value="" id="error_code_3" onBlur="setFieldname(this.name)"/>
                ...
                <div readonly="readonly" class="mdl-cell mdl-cell--2-col">
                    <div readonly="readonly" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group">
                        <input readonly="readonly" data-id="0" required="required" class="mdl-textfield__input add_media error_codes" pattern="[1,7,8,9]{1,1}" maxlength="1" data-maxlength="1" type="number" name="error_code_4" value="" id="error_code_4" onBlur="setFieldname(this.name)"/>
...
</div><?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/Diagnosis/ViewTabs/Analysis.blade.php ENDPATH**/ ?>