    ...
    <div class="box box-border">
        ...
        <div class="box-content">
            <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone field-row">
                    ...
                    <div id="function_checks_done" class="growinglist">
                        <div class="growinglist-item">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--no-floating-label form-group" readonly="readonly"><input readonly="readonly" class="mdl-textfield__input growinglist-item__input" type="text"><label class="mdl-textfield__label">Function checks</label></div>
                            <div class="growinglist-item__buttons"><i class="material-icons growinglist-item__button growinglist-item__button-check">check</i><i readonly="readonly" class="material-icons growinglist-item__button growinglist-item__button-remove">close</i></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone field-row mdl-zebra__desktop mdl-zebra__phone" readonly="readonly"><i readonly="readonly" class="material-icons error" data-for="complaint_mechanic">fiber_manual_record</i>
                ...
                <div class="mdl-cell mdl-cell--10-col mdl-cell--6-col-tablet mdl-cell--2-col-phone field-row" readonly="readonly"><i readonly="readonly" class="material-icons error" data-for="product_feature">fiber_manual_record</i><label>Product feature?</label></div>
                <div class="mdl-cell mdl-cell--2-col mdl-textfield--align-right"><label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="product_feature_5f19d87769715" readonly="readonly"><input readonly="readonly" value="1" class="mdl-radio__button saveonchange hascomment" large="1" name="product_feature" type="radio" id="product_feature_5f19d87769715"><span class="mdl-radio__label">Yes</span></label><label class="mdl-radio mdl-radio--large mdl-js-radio mdl-js-ripple-effect" for="product_feature_5f19d8776975c" readonly="readonly"><input readonly="readonly" value="0" class="mdl-radio__button saveonchange hascomment" large="1" name="product_feature" type="radio" id="product_feature_5f19d8776975c"><span class="mdl-radio__label">No</span></label></div>
...
<!-- Arpit: copy Line 114 to 118 -->
        <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored fixed-action-btn" 
		onclick="system.openInDialog(\'/json/test_drive/add/\' + diagnosis_id)">
...
</div><?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/Diagnosis/ViewTabs/Findings.blade.php ENDPATH**/ ?>