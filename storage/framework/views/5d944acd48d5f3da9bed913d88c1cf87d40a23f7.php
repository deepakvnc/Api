                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        $onclick= "window.location='".url('/diagnosis/edit', $item->id)."'";
                          ?>
                        <td onclick="window.location='<?php echo e(url('/diagnosis/edit', $item->id)); ?>'"   title="<?php echo $item->wo_number?>"><?php echo e($item->wo_number); ?></td>
                        <td onclick="window.location='<?php echo e(url('/diagnosis/edit', $item->id)); ?>'" title="<?php echo $item->complaint_customer?>"><?php echo e($item->complaint_customer); ?></td>
                        <td onclick="window.location='<?php echo e(url('/diagnosis/edit', $item->id)); ?>'" class="hidemobile" title="<?php echo $item->first_name?>"><?php echo e($item->first_name); ?> <?php echo e($item->surname_prefix); ?> <?php echo e($item->surname); ?></td>
                        <td onclick="window.location='<?php echo e(url('/diagnosis/edit', $item->id)); ?>'" title="<?php echo $item->complaint_number?>"><?php echo e($item->complaint_number); ?></td>
                        <td onclick="window.location='<?php echo e(url('/diagnosis/edit', $item->id)); ?>'" class="hidemobile" title="<?php echo $item->license_plate?>"><?php echo e($item->license_plate); ?></td>
                        <td onclick="window.location='<?php echo e(url('/diagnosis/edit', $item->id)); ?>'" class="hidemobile" title="<?php echo $item->vin?>"><?php echo e($item->vin); ?></td>
...
<?php /**PATH C:\xampp\htdocs\latest\16thsept1\resources\views/Diagnosis/Tabs/diagnosis.blade.php ENDPATH**/ ?>