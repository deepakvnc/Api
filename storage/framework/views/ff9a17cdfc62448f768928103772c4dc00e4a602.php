                ...
                <div class="mdl-cell mdl-cell--12-col" id="completeDiagnosis">
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--2-col mdl-cell--3-col-tablet mdl-cell--4-col-phone">
                            <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored" onclick="complete_diagnosis()">Close diagnosis</button>
                        </div>
                        <div class="mdl-cell mdl-cell--2-col mdl-cell--3-col-tablet mdl-cell--4-col-phone">
                            <button id="completeDiagnosisStartQualityControlButton" style="display:none" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored">Start Quality Control</button>
...
function complete_diagnosis()
    {
        
            $.post('/diagnosis/complete_diagnosis', {
                    '_token': '<?php echo e(csrf_token()); ?>',
                    'diagnosis_id': diagnosis_id.value
                
                }, function(success) {
                    console.log(success);
                    if(success.redirect){

                        window.location.href = '/diagnosis/#diagnosis_history_panel';
                    }
        })
    }
    </script>
<?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/Diagnosis/EditTabs/Complete.blade.php ENDPATH**/ ?>