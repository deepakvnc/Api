            ...
            <table id="quality_control_overview" class="datatable stripe">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    ?>
                            <td onclick="window.location='<?php echo e(url('/quality_control/edit', $item->id)); ?>'" title="<?php echo $item->wo_number?>">
                                <?php echo e($item->wo_number); ?></td>
                            <td onclick="window.location='<?php echo e(url('/quality_control/edit', $item->id)); ?>'" title="<?php echo $employee?>"><?php echo $employee?>

                                </td>
                                <td onclick="window.location='<?php echo e(url('/quality_control/edit', $item->id)); ?>'" title="<?php echo $inspector?>"><?php echo $inspector?>
                                    </td>
                                <td onclick="window.location='<?php echo e(url('/quality_control/edit', $item->id)); ?>'"
                                class="hidemobile" title="<?php echo $item->license_plate?>"><?php echo e($item->license_plate); ?></td>
...
<?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/inc/QualityControl/quality_control.blade.php ENDPATH**/ ?>