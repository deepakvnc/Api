                        ...
                        <div class="mdl-grid center-items">
                            ...
                            <i id="icon-inspector" class="material-icons"></i>
                                ...
                                <div class="mdl-selectfield mdl-js-selectfield is-dirty" tabindex="-1"><select
                                                ...
                                                name="inspector"  onchange="saveOnChange(value,'inspector')" value="<?php if($quality_control)  echo $quality_control[0]->inspector; else echo '';?>">                                     
                                                <?php
                            ...
                            <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-cell--4-col-phone field-row mdl-zebra__desktop mdl-zebra__phone">
                             <i id="icon-mechanic_id" class="material-icons"></i>
                                <div class="mdl-selectcontainer">
                                    ...
                                    <select class="fullwidth mdl-selectfield__select saveonchange" id="employee" name="employee" value="<?php if($quality_control)  echo $quality_control[0]->employee?>">
                                    <?php
                    ...
                    <div class="box-content">
                        <div class="mdl-grid">
                            <div class="mdl-cell mdl-cell--12-col">
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  fullwidth  form-group"><textarea class="mdl-textfield__input " type="text" name="comments" value="" id="comments"></textarea><label class="mdl-textfield__label" for="comments">Comments</label></div>
                            </div>
...
<?php echo $__env->make('layouts.index_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mbdiag\CodeForIntegration\Sasikala\latest_code\Latest_code\resources\views/QualityControl/EditPanels.blade.php ENDPATH**/ ?>