                                    ...
                                    <?php
                                      if($quality_control)
                                        $disabled = "disabled";
                                          ...
                                          $disabled ="";
                                     ?>
                                          <option value="" <?php echo $disabled?> style="display:none">&nbsp;</option>
                                         <?php
                                         for($i=0;$i<count($mechanics);$i++)
                                         {
                                             if($i>1)
                ...
                <div class="box box-border">
                    ...
                    <div class="box-content">
                        <div class="mdl-grid center-items">
                            ...
                            <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored next-tab" data-tab-next="media">Next<i class="material-icons">navigate_next</i></button>
                           </div>
                        </div>
                    </div>
                </div>
                ...
                $("#question_badge").html("<span class='mdl-badge' id='question_badge' data-badge='" + count + "'></span>");
                 ...
                 if(count==0){
                     if(info==2)
                     {
                        ...
                        question_next.style.display="block";
                     }
                 }
               }
               if (count > 0) {
...
<?php echo $__env->make('layouts.index_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\16thsept\resources\views/QualityControl/EditPanels.blade.php ENDPATH**/ ?>